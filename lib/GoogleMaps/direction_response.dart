...
//
//     final googleMapServices = googleMapServicesFromJson(jsonString);

// ignore_for_file: constant_identifier_names

import 'dart:convert';

GoogleMapServices googleMapServicesFromJson(String str) =>
    GoogleMapServices.fromJson(json.decode(str));

String googleMapServicesToJson(GoogleMapServices data) =>
...
class GoogleMapServices {
  ...
  factory GoogleMapServices.fromJson(Map<String, dynamic> json) =>
      GoogleMapServices(
