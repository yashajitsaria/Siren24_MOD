...
class _ProfileEditPageState extends State<ProfileEditPage> {
  ...
  String dob = userdata["dob"] == null ? "1995-02-22T00:00:00.000Z" : userdata["dob"];
  String gender = userdata["gender"] == null ? " " : userdata["gender"];
      ...
      builder:()=> GestureDetector(
        ...
        child: SafeArea(
          child: Scaffold(
            ...
            body: Center(
              child: Padding(
                padding: EdgeInsets.symmetric(vertical: 8.0.h, horizontal: 10.h),
                child: Container(
                  height: 650.h,
                  width: 450.h,
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            String x = await ApiCaller().editProfile(name, dob, gender, "https://cdn-icons-png.flaticon.com/512/21/21104.png", 20);
